...
start cmd.exe /C java client.ClientStarter C2 Razorback2 3 A 1 D 2 C 6
start cmd.exe /C java client.ClientStarter C3 Razorback2 3 E 2 C 6
start cmd.exe /C java client.ClientStarter C4 Razorback1 2 F 5
exit
